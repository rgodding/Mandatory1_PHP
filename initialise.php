<!-- 
Taken from: https://github.com/arturomorarioja/php_pdo/blob/main/initialise.php
Constants for the application so that i can use them in other files, constant nav, header and footer.
-->
<?php
